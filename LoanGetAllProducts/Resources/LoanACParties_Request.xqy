...
declare namespace ns1="http://www.mozabank.org/LOAN_ACCOUNT_PARTIES";
(:: import schema at "Schema/LOAN_ACCOUNT_PARTIES.xsd" ::)

declare variable $LoanACParties_Request as element() (:: schema-element(ns1:LOAN_ACCOUNT_PARTIESRequest) ::) external;
declare variable $userIdVar as xs:string external;

declare function local:func($LoanACParties_Request as element() (:: schema-element(ns1:LOAN_ACCOUNT_PARTIESRequest) ::),$userIdVar) as element() (:: schema-element(ns2:CCCRRequest) ::) {
    <ns2:CCCRRequest>
...
local:func($LoanACParties_Request,$userIdVar)