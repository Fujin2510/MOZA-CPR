...
declare namespace ns1="http://www.mozabanca.org/DOMESTIC_TRANSFER_NEFT";
    ...
    return
      if (contains($acct, "@~")) then
        ...
        $acct
            ...
            <ns2:PTFZ_I_0002>{fn:data($Request/ns1:amount/ns1:amount)*100}</ns2:PTFZ_I_0002>
            <ns2:PTFZ_I_0003>{fn:data($Request/ns1:amount/ns1:currency)}</ns2:PTFZ_I_0003>
            <ns2:PTFZ_I_0004>{fn:data($Request/ns1:beneficiary/ns1:accountId)}</ns2:PTFZ_I_0004>
            <ns2:PTFZ_I_0005>{fn:data($Request/ns1:beneficiary/ns1:accountName)}</ns2:PTFZ_I_0005>
            <ns2:PTFZ_I_0006>{fn:data($Request/ns1:remarks)}</ns2:PTFZ_I_0006>
            <ns2:PTFZ_I_0007>E</ns2:PTFZ_I_0007>
            <ns2:PTFZ_I_0008>{' '}</ns2:PTFZ_I_0008>            
          <ns2:PTFZ_I_0009>{' '}</ns2:PTFZ_I_0009>
          <ns2:PTFZ_I_0010>{' '}</ns2:PTFZ_I_0010>
          <ns2:PTFZ_I_0011>{' '}</ns2:PTFZ_I_0011>
