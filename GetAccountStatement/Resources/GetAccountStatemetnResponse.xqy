            ...
            (
              ...
              <ns2:statementItemList>
                ...
                <ns2:amount>
                  ...
                  <ns2:amount>{fn-bea:format-number(xs:decimal(fn:data($cmovResp/ns1:CMOV_O_0011_0006)) div 100, '0.00')}</ns2:amount>
                </ns2:amount>
                ...
                <ns2:amount>{fn-bea:format-number(xs:decimal(fn:data($cmovResp/ns1:CMOV_O_0011_0012)) div 100, '0.00')}</ns2:amount>
                                    </ns2:runningBalance>
