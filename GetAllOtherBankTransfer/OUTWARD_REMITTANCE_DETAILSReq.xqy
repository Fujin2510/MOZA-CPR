...
declare variable $OUTWARDREMITTANCEDETAILSReq as element() (:: schema-element(ns1:Request) ::) external;

declare function local:func($userIdVar as xs:string, 
                            $accountID as xs:string, 
                            $OUTWARDREMITTANCEDETAILSReq as element() (:: schema-element(ns1:Request) ::)) 
...
local:func($userIdVar, $accountID, $OUTWARDREMITTANCEDETAILSReq)