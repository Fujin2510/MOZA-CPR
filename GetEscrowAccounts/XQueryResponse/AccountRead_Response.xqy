...
declare function local:func($CDCC_Response as element() (:: schema-element(ns1:Response) ::)) as element() (:: schema-element(ns2:Response) ::) {
    <ns2:Response>
    <ns2:data>
        ...
        <ns2:result>
            ...
            <ns2:status>
              {
                if (fn:data($CDCC_Response/ns1:errorCode) = '0')
                then 'SUCCESS'
                else 'FAILURE'
              }
            </ns2:status>
            ...
            {
              if (fn:data($CDCC_Response/ns1:errorCode) != '0') then (
                <ns2:errorList>
  ...
  return 
    if ($date != '' and $date != '00000000') then 
      ...
      ()
            ...
            <ns2:interestRate>
            {
              xs:decimal(fn:data($CDCC_Response/ns1:operationData/ns1:CDCC_O_0022)) div 1000000
            }
            </ns2:interestRate>
        </ns2:account>
        </ns2:data>
