...
declare namespace ns2="http://www.mozabanca.org/cccc";
(:: import schema at "../MSB_Schema/CCCC.xsd" ::)
declare namespace ns1="http://www.mozabank.org/CCC_ACCOUNTS_LIST";
...
declare function local:func($Request as element() (:: schema-element(ns1:Request) ::), $userIdVar as xs:string) as element() (:: schema-element(ns2:Request) ::) {
    <ns2:Request>
        ...
        <ns2:transactionCode>CCCC</ns2:transactionCode>
        <ns2:operationData>
            <ns2:CCCC_I_0001>40</ns2:CCCC_I_0001>
            <ns2:CCCC_I_0004>N</ns2:CCCC_I_0004>
            <ns2:CCCC_I_0005>N</ns2:CCCC_I_0005>
        </ns2:operationData>
    </ns2:Request>
};
