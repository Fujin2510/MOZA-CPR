...
declare namespace ns1="http://www.mozabank.org/CCC_ACCOUNT_READ";
(:: import schema at "../OBDX_Schema/CCC_ACCOUNT_READ.xsd" ::)
declare namespace ns2="http://www.mozabanca.org/cdcc";
...
declare function local:func($Request as element() (:: schema-element(ns1:Request) ::),$userIdVar as xs:string) as element() (:: schema-element(ns2:Request) ::) {
    <ns2:Request>
        ...
        <ns2:channelCode>IAR</ns2:channelCode>
        <ns2:version>R30</ns2:version>
        <ns2:licenceKey>licenseKey</ns2:licenceKey>
        <ns2:sessionId></ns2:sessionId>
        <ns2:transactionCode>CDCC</ns2:transactionCode>
        <ns2:operationData>
            <ns2:CDCC_I_0001>{fn:data($Request/ns1:account)}</ns2:CDCC_I_0001>
        </ns2:operationData>
    </ns2:Request>
};
