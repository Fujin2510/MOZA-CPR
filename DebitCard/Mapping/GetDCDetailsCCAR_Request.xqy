...
declare variable $CarRequest as element() (:: schema-element(ns1:Request) ::) external;
declare variable $userIdVar as xs:string external;
declare function local:func($CarRequest as element() (:: schema-element(ns1:Request) ::),$userIdVar) as element() (:: schema-element(ns2:Request) ::) {
    <ns2:Request>
        ...
        <ns2:operationData>
            ...
            <ns2:CCAR_I_0002></ns2:CCAR_I_0002>
            <ns2:CCAR_I_0003>S</ns2:CCAR_I_0003>
            <ns2:CCAR_I_0004>N</ns2:CCAR_I_0004>
            <ns2:CCAR_I_0007>{fn:data($CarRequest/ns1:accountId)}</ns2:CCAR_I_0007>
        </ns2:operationData>
    </ns2:Request>
};

local:func($CarRequest,$userIdVar)