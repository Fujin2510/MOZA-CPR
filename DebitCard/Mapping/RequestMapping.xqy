...
declare function local:func($OBDX_Request as element() (:: schema-element(ns1:DebitCardReadRequest) ::)) as element() (:: schema-element(ns2:Request) ::) {
    <ns2:Request>
        <ns2:user>{fn:data($OBDX_Request/ns1:entity)}</ns2:user>
