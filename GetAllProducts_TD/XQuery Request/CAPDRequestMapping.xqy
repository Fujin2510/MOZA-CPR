...
declare variable $accountObjectVar as xs:string external;
declare function local:func($RequestTDAccPartyListSummary as element() (:: schema-element(ns1:Request) ::), 
                            ...
                            $RequestPartyTDAccList as element() (:: schema-element(ns1:Request) ::),$accountObjectVar) 
                            as element() (:: schema-element(ns4:CAPDRequest) ::) {
    <ns4:CAPDRequest>
        <ns4:user>{fn:data($RequestTDList/*:partyId)}</ns4:user>
        ...
        <ns4:operationData>
            <ns4:CAPD_I_0001>{fn:data($accountObjectVar)}</ns4:CAPD_I_0001>
        </ns4:operationData>
    </ns4:CAPDRequest>
};

local:func($RequestTDAccPartyListSummary, $RequestTDList, $RequestPartyTDAccList,$accountObjectVar)