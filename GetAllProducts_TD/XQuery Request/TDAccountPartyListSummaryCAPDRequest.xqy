...
declare function local:func($RequestTDAccPartyListSummary as element() (:: schema-element(ns1:Request) ::), 
                            ...
                            $RequestPartyTDAccList as element() (:: schema-element(ns1:Request) ::),$accountIdVar as xs:string) 
                            as element() (:: schema-element(ns4:CAPDRequest) ::) {
    <ns4:CAPDRequest>
        <ns4:user>{fn:data($RequestTDAccPartyListSummary/ns1:partyId)}</ns4:user>
        ...
        <ns4:operationData>
            <ns4:CAPD_I_0001>{$accountIdVar}</ns4:CAPD_I_0001>
        </ns4:operationData>
    </ns4:CAPDRequest>
};

local:func($RequestTDAccPartyListSummary, $RequestTDList, $RequestPartyTDAccList,$accountIdVar)