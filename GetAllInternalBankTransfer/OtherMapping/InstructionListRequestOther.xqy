...
declare function local:func($Request as element() (:: schema-element(ns1:Request) ::),$userIdVar as xs:string,$accountId,$externalStatus ) as element() (:: schema-element(ns2:Request) ::) {
        <ns2:Request>
...
local:func($Request,$userIdVar,$accountId,$externalStatus )