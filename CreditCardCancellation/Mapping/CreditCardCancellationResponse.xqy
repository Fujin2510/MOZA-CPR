...
declare namespace ns2="http://www.mozabanca.org/obdx/cc_upd_status";
...
declare function local:func($Request as element() (:: schema-element(ns1:Response) ::)) as element() (:: schema-element(ns2:Response) ::) {
     <ns2:Response>
        ...
        <ns2:result>
            ...
            <ns2:status>{if(fn:data($Request/ns1:errorCode) = '0') then 'SUCCESS' else 'FAILURE'}</ns2:status>
        ...
        <ns2:referenceNo>{fn:data($Request/ns1:operationData/ns1:CCEM_O_0001)}</ns2:referenceNo>
        </ns2:data>      
    </ns2:Response>
};
