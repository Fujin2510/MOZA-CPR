...
declare namespace ns1="http://www.mozabanca.org/obdx/INSS_GUIDE_NO_DETAILS";
...
declare function local:func($OBDX_Request as element() (:: schema-element(ns1:Request) ::),$accessToken as xs:string) as element() (:: schema-element(ns2:Consulta) ::) {
    <ns2:Consulta>
        <ns2:input>
            <chaveConfirmacao>
                <chave></chave>
