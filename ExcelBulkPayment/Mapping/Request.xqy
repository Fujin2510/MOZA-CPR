...
declare function local:func($OBDX_Request as element() (:: schema-element(ns1:Request) ::),$partyIdVar ,$accessToken as xs:string) as element() (:: schema-element(ns2:CarregarFicheiroSalario) ::) {
    <ns2:CarregarFicheiroSalario>
        <input>
            <chaveConfirmacao>
                <chave></chave>
                <posicoes></posicoes>
