...
declare variable $MSB_Response as element() (:: schema-element(ns1:CarregarFicheiroFornecedorResponse) ::) external;

declare function local:func($MSB_Response as element() (:: schema-element(ns1:CarregarFicheiroFornecedorResponse) ::)) as element() (:: schema-element(ns2:Response) ::) {
    <ns2:Response>
        <ns2:data>
