...
declare variable $RequestLacCcrd as element() (:: schema-element(ns1:Request) ::) external;
declare variable $UserIdVar as xs:string external;
declare function local:func($RequestLacCcrd as element() (:: schema-element(ns1:Request) ::),$UserIdVar) as element() (:: schema-element(ns2:CCCRRequest) ::) {
    <ns2:CCCRRequest>
...
local:func($RequestLacCcrd,$UserIdVar)