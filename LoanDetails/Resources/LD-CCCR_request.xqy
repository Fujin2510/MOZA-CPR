...
declare variable $CccrRequest as element() (:: schema-element(ns1:LoanDetailsRequest) ::) external;
declare variable $userIdVar as xs:string external;

declare function local:func($CccrRequest as element() (:: schema-element(ns1:LoanDetailsRequest) ::),$userIdVar) as element() (:: schema-element(ns2:CCCRRequest) ::) {
    <ns2:CCCRRequest>
        <ns2:user>{$userIdVar}</ns2:user> <!-- value to be taken from header -->
        ...
        <ns2:operationData>
            ...
            <ns2:CCCR_I_0005>N</ns2:CCCR_I_0005>
        </ns2:operationData>
    </ns2:CCCRRequest>
};

local:func($CccrRequest,$userIdVar)