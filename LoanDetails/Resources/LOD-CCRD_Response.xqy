        ...
        <ns2:data>
          <ns2:dictionaryArray></ns2:dictionaryArray>
            ...
            <ns2:principalBalance>
                ...
                <ns2:amount>
  {fn-bea:format-number(fn:data($cccr/ns1:CCRD/ns1:CCRD_O_0012) div 100, '0.00')}
</ns2:amount>
            ...
            <ns2:outstandingAmount>
                <ns2:currency>{fn:data($cccr/ns1:CCRD/ns1:CCRD_O_0014)}</ns2:currency>
                <ns2:amount>{fn-bea:format-number(fn:data($cccr/ns1:CCRD/ns1:CCRD_O_0013) div 100, '0.00')}</ns2:amount>
            </ns2:outstandingAmount>
            <ns2:serviceCharges>
                <ns2:currency>{fn:data($cccr/ns1:CCRD/ns1:CCRD_O_0014)}</ns2:currency>
                <ns2:amount>0.00</ns2:amount>
            ...
            <ns2:installmentArrear>
                <ns2:currency>{fn:data($cccr/ns1:CCRD/ns1:CCRD_O_0014)}</ns2:currency>
              <ns2:amount>
  {fn-bea:format-number(fn:data($cccr/ns1:CCRD/ns1:CCRD_O_0017) div 100, '0.00')}
</ns2:amount>
