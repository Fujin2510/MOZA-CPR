...
declare namespace ns1="http://www.mozabanca.org/rapp";
(:: import schema at "../XSD/RAPP.xsd" ::)
declare namespace ns2="http://www.mozabanca.org/obdx/td_topup";
    ...
    <ns2:Response>
        <ns2:data>
          ...
          <ns2:errorList>
            ...
            {
                 if($errCode = '0') then 
                <ns2:topUpReferenceNumber>{fn:data($Response/ns1:coreLogKey)}</ns2:topUpReferenceNumber>
            else() }
        </ns2:data>
    </ns2:Response>
};
